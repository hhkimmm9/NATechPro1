        ...
        <div className="max-w-3xl bg-stone-200 w-2/3 mx-auto mt-6 p-6">
          <div className="flex">
            ...
            <div className="w-1/2 flex justify-center">
              <img
                src="https://easydrawingguides.com/wp-content/uploads/2022/07/pug-face-11.png"
                alt=""
              />
            </div>
          </div>
          <button className="rounded-2xl text-white py-1.5 px-5 bg-amber-600 mt-6 text-sm">
            Try now
          </button>
        </div>
      </div>
      ...
      <div className="bg-orange-100 text-center py-6 flex flex-col gap-8">
        ...
        <div className="flex justify-around">
          <div className="flex flex-col">
            <img
              src="https://images.unsplash.com/photo-1543320317-15188058b450?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cHVnJTIwZmFjZXxlbnwwfHwwfHw%3D&w=1000&q=80"
              alt=""
