...
const page = () => {
        ...
        <input {...getInputProps()} />
        {
          isDragActive ?
            ...
            <div className='flex flex-col gap-3 items-center'>
              <p className='font-medium text-lg cursor-pointer'>Drag 'n' drop some files here, or click to select files</p>
  ...
  useEffect(() => {
    const getImgs = async () => {
      axios.get(`/api/gallery?userID=${userID}&tags=background,`)
        .then((res) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // who would do this? FE js filter? or another req to BE?
    // axios.post('', )
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-row justify-between items-center'>
              ...
              <div ref={dropdownRef} className='flex justify-end gap-2 relative z-0'>
                <button onClick={() => { setDropdownType('sort'); setShowDropdown(true);}} className='px-3 py-2 border rounded-full whitespace-nowrap'>sort pl</button>
                ...
                { showDropdown && (
                  <div className='absolute z-10 top-12 left-0 right-0 rounded-2xl shadow-2xl bg-white py-4 border'>
                    { dropdownContent() }
                  </div>
                )}
              </div>
            ...
            '>
              ...
              <div className='flex flex-col justify-center items-center bg-stone-100 h-full w-full shadow hover:bg-stone-50'>
                { MyDropzone() }
              </div>
